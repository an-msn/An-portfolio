          ...
          >
            <g transform="translate(825.000000, 1100.000000)">
              ...
              >
                ...
                <g
                  id="Face"
                  transform={`translate(76.000000, 82.000000) rotate(${
                    faceTilt * 0.2
                  }, 132, 140)`}
                  fill="#000000"
                >
                ...
                <g id="Top" strokeWidth="1" fillRule="evenodd">
                  ...
                  <g id="Mask"></g>
                  <g id="Top/Short-Hair/Dreads-01" mask="url(#react-mask-10)">
                      ...
                      >
                        ...
                        <g id="Lennon-Glasses">
                          <use
                            fill="black"
                            fillOpacity="1"
                            filter="url(#react-filter-17)"
                            xlinkHref="#react-path-16"
                          ></use>
                          <use
                            fill="#252C2F"
                            fillRule="evenodd"
